...
This analysis solidifies the assertion made by __Todd Vaziri__ that "Every non-hyperbolic tweet is from iPhone (his staff). Every hyperbolic tweet is from Android (from him)."
